...
export const homeContent: HomeContent = {
  headerFooter: {
    en: {
      ...
      copyright: "© 2026 American Magic Hair. All rights reserved.",
      createdBy: "Created by Optima Creative",
    },
    ar: {
      cta: "اطلب ملف المستثمر",
      copyright: "© 2026 أمريكان ماجيك هير. جميع الحقوق محفوظة.",
      createdBy: "تم الإنشاء بواسطة أوبتيما كرييتف",
    },
  },
  ...
  businessModel: {
    en: {
      ...
      storyItems: [
        {
          label: "Botanic",
          caption: "Lead product positioning for premium market entry.",
        },
        {
          label: "Portfolio Kit",
          caption: "Structured presentation for broader commercial expansion.",
        },
        {
          label: "Visible Result",
          caption: "A stronger product story for salon decision-makers.",
        },
      ],
    },
    ar: {
      ...
      storyItems: [
        {
          label: "بوتانيك",
          caption: "تموضع المنتج الرئيسي لدخول أقوى إلى السوق الفاخر.",
        },
        {
          label: "مجموعة المنتجات",
          caption: "عرض منظم لتوسيع التطوير التجاري.",
        },
        {
          label: "نتيجة واضحة",
          caption: "قصة منتج أقوى أمام صالونات القرار.",
        },
      ],
    },
  },

  whatsappHref: "https://wa.me/5521920202614",
};